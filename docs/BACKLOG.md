...
**Tasks**
- [ ] P0•M — Ребрендинг главного экрана в «ЦУП» с расшифровкой «Центр Управления Полётами» и единым копирайтингом.
- [ ] P0•M — Встроить админские утилиты в ЦУП (видны только роли admin) с отдельным подзаголовком и якорем для навигации из меню.
**Acceptance Criteria**
