...
- [ ] P1•S — Документировать CRM-архитектуру и автоматизации в `docs/vision.md`, `docs/conventions.md` и подготовить матрицу роботов.
...
- Документация (vision, conventions) содержит правила данных, автоматизации и UX CRM; `docs/CHANGELOG.md` фиксирует релизы.
