...
Схема базы данных управляется Alembic. После изменения моделей необходимо
...
В тестовой среде для SQLite можно использовать `Base.metadata.create_all`,
но в рабочем окружении применяются только миграции.
