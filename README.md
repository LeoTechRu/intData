...
- **PARA‑first.** Любая сущность относится к **Проекту** или **Области**; проекты принадлежат областям. Нет «ничейных» задач и заметок.
...
scripts/       # утилиты (проверки БД/зависимостей и т.п.)
```
