...
### Следующие шаги
- [ ] Перевести формы входа и регистрации на новый шаблон авторизации.
...
- [ ] Реализовать перенаправление заблокированных пользователей на страницу `ban.html`.
- [ ] Добавить поиск и фильтрацию пользователей в админ‑панели.
