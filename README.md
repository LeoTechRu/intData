...
- [ ] Расширить CRUD задач и напоминаний: добавить обновление и удаление.
- [ ] Настроить фоновый планировщик и рассылку уведомлений по напоминаниям.
- [x] Интегрировать тайм-трекер: команды `start/stop` в боте и отображение записей в веб-интерфейсе.
- [x] Добавить интерфейсы для заметок и событий календаря (бот и веб).
...
- [x] Развивать таск-систему: добавить напоминания и интеграцию с ботом и веб-интерфейсом.
...
- [x] Веб-интерфейс с авторизацией через Telegram и админ-панелью.
