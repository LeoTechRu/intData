...
HELP_SECTIONS = (
    ...
    (
        "Задачи",
        (
            {"text": "/task_add - создать задачу (Inbox)."},
            {"text": "/task_rename - переименовать задачу."},
            {"text": "/task_due - установить дедлайн."},
            {"text": "/task_remind - настроить напоминание."},
            {"text": "/task_control - включить контроль после срока."},
            {"text": "/task_forget - завершить контроль (выполнена/не будет выполнена)."},
            {"text": "/task_watch <id> <пользователь> - добавить наблюдателя."},
            {"text": "/task_unwatch <id> - отказаться от наблюдения."},
            {"text": "/task_stats - статистика выполненных/актуальных/отказанных задач."},
            {"text": "/task_stats_active | /task_stats_dropped - быстрые метрики."},
        ),
    ),
    (
        "Тайм-трекер",
