...
|-------------|-------|------|--------|------|--------------|----------------|----|---------|--------|
| 2025-09-19 18:29 | codex | fe | feature/E10/notes-restore-frontend | TL-2025-09-19-notes-restore-frontend | E10 / восстановление заметок (frontend) | web/components/notes/*, web/app/notes/page.tsx | — | [AC](README.md#e10-capture-%D0%B1%D0%BE%D1%82%D0%B2%D0%B5%D0%B1-inbox) | готово, ждёт PR в test |
